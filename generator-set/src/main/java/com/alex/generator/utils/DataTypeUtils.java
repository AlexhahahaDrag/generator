package com.alex.generator.utils;

/**
 * @Description: 数据类型工具类
 * 各数据库与java对应关系详见：https://blog.csdn.net/haofeng82/article/details/34857991
 * @Author:     alex
...
public class DataTypeUtils {
    ...
    public static final String CHAR_FOR_BIT_DATA = "CHAR_FOR_BIT_DATA";
    ...
    /**
     * @Description: 根据数据库类型获取对应的java类型
     * @Author:      alex
     * @CreateDate:  2019/11/14 10:46
     * @param
     * @return
     */
    ...
    /**
     * @Description: 根据数据库类型获取对应的jdbc类型
     * @Author:      alex
     * @CreateDate:  2019/11/14 11:00
     * @param
     * @return
    */
